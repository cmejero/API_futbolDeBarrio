...
@Service
/**
 * Clase que se encarga de la lógica de los metodos CRUD de EventoPartido
 */
public class EventoPartidoFuncionalidades {
	...
	public EventoPartidoEntidad mapearAEventoPartidoEntidad(EventoPartidoDto eventoPartidoDto) {
		...
		ClubEntidad club = clubInterfaz.findById(eventoPartidoDto.getClubId()).orElseThrow(
				() -> new IllegalArgumentException("El club con ID " + eventoPartidoDto.getClubId() + " no existe"));
	...
	public ArrayList<EventoPartidoDto> mostrarEventosPartidos() {
		...
		ArrayList<EventoPartidoEntidad> listaEventoPartidoEntidad = (ArrayList<EventoPartidoEntidad>) eventoPartidoInterfaz
				.findAll();
