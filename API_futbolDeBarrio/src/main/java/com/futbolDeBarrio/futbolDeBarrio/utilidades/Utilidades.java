...
public class Utilidades {
    ...
    /**
     * Método que verifica si la contraseña ingresada coincide con el hash almacenado.
     * @param contraseñaIngresada la contraseña que el usuario ingresa
     * @param hashAlmacenado el hash de la contraseña almacenado
     * @return true si la contraseña ingresada coincide con el hash almacenado, false en caso contrario
     */
